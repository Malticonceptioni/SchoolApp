...
class ParentHomePage extends React.Component {
                ...
                <ScrollView>
                    ...
                    {/* <Text style={styles.subheaderTitle}>Good Morning!</Text>
                        ...
                        <FlatList
                            ...
                            numColumns={2}
                            data={[
                                { position: '1', name: 'Professor', color: Global.FirstColor },
                                { position: '2', name: 'Students', color:Global.SecondColor },
