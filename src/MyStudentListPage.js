...
// create a component
class MyStudentListPage extends Component {
            ...
            <View style={styles.container}>
                ...
                <LinearGradient useAngle={true} angle={45} angleCenter={{ x: 0.5, y: 0.5 }}
                    ...
                    <View style={{ height: 56, justifyContent: 'center' }}>
                        ...
                        <Text style={{ lineSpacing: 2, alignSelf: 'center', fontSize: 25, fontFamily: Global.FontName, color: '#D13076' }}>My Students</Text>
                    </View>
                </LinearGradient>
